            ...
            <div className="container py-5 my-5">
                <div className="row ">
                    <div className="col-md-6">
                        ...
                        <p className="lead mb-4 fs-3">Công ty Cổ Phần TM-DV-SX GNAHYUD(GNAHYUD HD) được ra đời vào năm 2022 và thành lập chính thức vào năm 2022 với khởi nguồn từ Trường Suối Nhạc – trường tư thục âm nhạc đầu tiên tại Việt Nam.
